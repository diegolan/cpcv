...
public class ConsultaClienteImpressaoGUI extends JFrame {
	...
	protected ConsultaClienteImpressaoGUI(ClientService clientService) {
	...
	private void initComponents() {
		...
		this.tabela.addMouseListener(new MouseAdapter() {
			public void mouseClicked(MouseEvent evt) {
				ConsultaClienteImpressaoGUI.this.tabelaMouseClicked(evt);
			}
		});
		...
		this.botaoLimpar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent evt) {
				ConsultaClienteImpressaoGUI.this.botaoLimparActionPerformed(evt);
			}
		});
		...
		this.botaoPesquisar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent evt) {
				ConsultaClienteImpressaoGUI.this.botaoPesquisarActionPerformed(evt);
			}
		});
	...
	private void tabelaMouseClicked(MouseEvent evt) {
		...
		if (qtdCliques >= 2) {
			...
			NovoClienteSelecionaGUI gui = new NovoClienteSelecionaGUI(c);
